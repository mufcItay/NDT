...
apa_table(
  ...
  # align = c("l{2.5cm}", "l{1.5cm}", "l{2cm}", "l{0.8cm}", "l{7cm}"),
...
(ref:sfigure2caption) Supplementary Figure 2. The results of applying the Sign-Consistency test to significant directional effects (N = 7). The x-axis lists effect labels. Same conventions as Fig. 4.
...
# run the analysis to reproduce the output file. Here we just load the analyzed file
# appendix_A_res <- read.csv('appendix\\results\\2023-05-02_11_32_45Appendix_A_QUID_OANOVA.csv')
