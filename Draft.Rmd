...
# sourcing the 'fig2_3' script generates figure2,4 and supplementary figure 1,2
# it also analyzes the results of all datasets according to all tests
source('figures\\fig2_3.R')
# sourcing the 'fig4' script generates figure4.
# it also analyzes the results of all datasets according to all tests
...
```{r figure1, out.width="100%", fig.cap = "\\label{fig:figure1}(ref:figure1-caption)"} 
...
apa_table(
  ...
  align = c("p{2.5cm}", "p{1.5cm}", "p{2cm}", "p{0.8cm}", "p{7cm}"),
...
# Supplementary Figure 1 - PBT & QUID results for datasets showing a directional effect {#SFig-1}

(ref:sfigure1-caption)  Supplementary Figure 1. The results of applying the PBT (A), QUID (B) and OANOVA (C) tests to effects that produced significant results in a non-parametric directional test. Same conventions as Fig. 2.
```{r Sfigure1, out.width="100%", fig.cap="\\label{fig:figures1}(ref:sfigure1-caption)", warning = FALSE}
...
(ref:sfigure2-caption) Supplementary Figure 2. The results of applying the Sign-Consistency test to significant directional effects (N = 7). The x-axis lists effect labels. Same conventions as Fig. 4.
```{r sfigure2, out.width="100%", fig.cap = "\\label{fig:figures2}(ref:sfigure2-caption)", warning = FALSE}
