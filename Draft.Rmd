...
# removing experiments where the same effect
...
apa_table(
  ...
  # align = c("l{2cm}", "l{1.5cm}", "l{3cm}", "l{0.8cm}", "l{4cm}"),
  font_size = 'small')#"footnotesize")
```
