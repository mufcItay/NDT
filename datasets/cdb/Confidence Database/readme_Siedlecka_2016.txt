...
Stimulus column is coded 1 - when the target word was not the solution of the anagram and 2 - if it was the solution.
...
'Stimulus'  	: 1 - target is not the solution, 2 - target is the solution
