...
Manipulations
There were no manipulations within this sample, but materials type is indicated in the Condition column to enable comparison with our other datasets. The Stim_idx column includes unique stimulus identifiers.
...
Experiment goal
This experiment was part of an ongoing research line exploring materials-based differences in recognition memory response bias (see e.g., Lindsay & Kantner, 2011, https://doi.org/10.1057/9780230305281_11; Lindsay, Kantner, & Fallow, 2015, in https://doi.org/10.4324/9781315752808). Here we sought to establish whether the conservative response bias consistently obtained in recognition memory studies using paintings as stimuli was also observed with complex photographs.

Main result
Response bias (c) was significantly conservative for these scene photographs.

Materials
Scene stimuli are available at https://osf.io/eya5x/, and were obtained from the FIGRIM dataset (http://figrim.mit.edu/; see Bylinskii, Isola, Bainbridge, Torralba, & Oliva, 2015, Vision Res), which contains a subset of images originally from the SUN database (http://groups.csail.mit.edu/vision/SUN/; see Xiao, Hays, Ehinger, Oliva, & Torralba, 2010, Proc CVPR IEEE).
