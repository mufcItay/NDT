...
Citation:
Wang S, Adolphs R. 2017. Reduced specificity in emotion judgment in people with autism spectrum disorder. Neuropsychologia 99: 286-95
...
Participants:
Data from eleven high-functioning participants with autism spectrum disorder (ASD) and eleven healthy controls are included. Note that in the original publication there are 18 participants with ASD and 15 healthy controls, here we only include the participants who had confidence ratings.
...
Each anchor face and each morphed face was presented the same number of times (12 times, 3 repetitions for each identity). Participants all performed 3 blocks.
